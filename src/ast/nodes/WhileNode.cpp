...
//
//WhileNode::WhileNode(AstNode *parent) : AstNode(parent) { };
//
//AstNode*              WhileNode::getCondNode() { return condNode; };
//std::vector<AstNode*> WhileNode::getStmNodes() { return stmNodes; };
//
