...
antlrcpp::Any AstBuilder::visitAssignstm(DplParser::AssignstmContext* parseNode) {
    return binaryNode([this]() {
        return std::make_shared<AssignNode>(currentNode);
    }, parseNode, 0, 2, "Assign"); 
}

// Return
antlrcpp::Any AstBuilder::visitReturnstm(DplParser::ReturnstmContext* parseNode) {
    return unaryNode([this]() {
        return std::make_shared<ReturnNode>(currentNode);
    }, parseNode, 1, "Return");
}

antlrcpp::Any AstBuilder::visitElsestm(DplParser::ElsestmContext* parseNode) {
    return unaryNode([this]() {
        return std::make_shared<ElseNode>(currentNode);
    }, parseNode, 2, "Else");
}
...
antlrcpp::Any AstBuilder::visitWhilestm(DplParser::WhilestmContext* parseNode) {
    return binaryNode([this]() {
        return std::make_shared<WhileNode>(currentNode);
    }, parseNode, 1, 3, "While");
}


antlrcpp::Any AstBuilder::visitJuncexpr(DplParser::JuncexprContext* parseNode) {
    return binaryExpr([this](int operatorType) -> std::shared_ptr<AstNode> {
        switch (operatorType) {
            case DplLexer::And:
...
antlrcpp::Any AstBuilder::visitNotexpr(DplParser::NotexprContext* parseNode) {
    return unaryExpr([this](int operatorType) -> std::shared_ptr<AstNode> {
...
antlrcpp::Any AstBuilder::visitExpoexpr(DplParser::ExpoexprContext* parseNode) {
    return binaryExpr([this](int operatorType) {
        return std::make_shared<ExpoExprNode>(currentNode);
    }, parseNode);          
}

antlrcpp::Any AstBuilder::visitList(DplParser::ListContext* parseNode) {
    int index = (parseNode->children.size() == 3) ? 1 : 9; // dirty way to not vitit children if empty list
    return unaryNode([this]() {
        return std::make_shared<ListNode>(currentNode);
    }, parseNode, index, "[] List");
}

antlrcpp::Any AstBuilder::visitTable(DplParser::TableContext* parseNode) {
    return unaryNodeList([this]() {
        return std::make_shared<TableNode>(currentNode);
    }, parseNode, 1, 2, "{} Table");
}
...
antlrcpp::Any AstBuilder::visitColumn(DplParser::ColumnContext* parseNode) {
    ...
    return unaryNode([this]() {
        return std::make_shared<ColumnNode>(currentNode);
    }, parseNode, 2, text);
}
...
antlrcpp::Any AstBuilder::visitTerm(DplParser::TermContext* parseNode) {
    ...
    return unaryNode([this]() { // Capture 'this' pointer in the lambda capture list
...
antlrcpp::Any AstBuilder::visitSubscript(DplParser::SubscriptContext* parseNode) {
    ...
    for (size_t i = childAmount-1; i > 0; i--) {
        parseNode->children[i]->accept(this);
        if (i == 1) parseNode->children[0]->accept(this);
    }
...
antlrcpp::Any AstBuilder::visitIndex(DplParser::IndexContext* parseNode) {
    return unaryNode([this]() {
        return std::make_shared<IndexNode>(currentNode);
    }, parseNode, 1, "[] Index", false);
}

antlrcpp::Any AstBuilder::visitHeaderindex(DplParser::HeaderindexContext* parseNode) {
    return unaryNode([this]() {
        return std::make_shared<HeaderIndexNode>(currentNode);
    }, parseNode, 2, "[$] Header Indexing", false);
}

antlrcpp::Any AstBuilder::visitFiltering(DplParser::FilteringContext* parseNode) {
    return unaryNode([this]() {
        return std::make_shared<FilterNode>(currentNode);
    }, parseNode, 1, "[] Filter", false);
}
// To here
...
antlrcpp::Any AstBuilder::visitUnaryexpr(DplParser::UnaryexprContext* parseNode) {
    return unaryNode([this]() {
        return std::make_shared<UnaryExprNode>(currentNode);
    }, parseNode, 1, parseNode->children[0]->getText());
}
...
// util
void AstBuilder::initNewNode(antlr4::ParserRuleContext* parseNode, std::shared_ptr<AstNode> newNode, const std::string& text) {
    newNode->setRule(parseNode->getRuleIndex());
    newNode->setText(
        (text != "") ? text : parser->getRuleNames()[newNode->getRule()]
    );
    currentNode->addChild(newNode);
    currentNode = newNode;
}

antlrcpp::Any AstBuilder::unaryNode(std::function<std::shared_ptr<AstNode>()> createNode, antlr4::ParserRuleContext* parseNode, int childIndex, const std::string& text, bool restoreOldCurrent) {
    std::shared_ptr<AstNode> oldNode = currentNode;
    ...
    if (restoreOldCurrent) currentNode = oldNode;

    return nullptr;
}


antlrcpp::Any AstBuilder::unaryNodeList(std::function<std::shared_ptr<AstNode>()> createNode, antlr4::ParserRuleContext* parseNode, int startIndex, int interval, const std::string& text) {
    std::shared_ptr<AstNode> oldNode = currentNode;
    std::shared_ptr<AstNode> newNode = createNode();
    initNewNode(parseNode, newNode, text);

    for (int i = startIndex; i < parseNode->children.size(); i = i + interval) {
        parseNode->children[i]->accept(this);
    }
...
antlrcpp::Any AstBuilder::binaryNode(std::function<std::shared_ptr<AstNode>()> createNode, antlr4::ParserRuleContext* parseNode, int leftIndex, int rightIndex, bool restoreOldCurrent, const std::string& text) {
    std::shared_ptr<AstNode> oldNode = currentNode;
    std::shared_ptr<AstNode> newNode = createNode();
    initNewNode(parseNode, newNode, text);
...
antlrcpp::Any AstBuilder::unaryExpr(std::function<std::shared_ptr<AstNode>(int)> createNode, antlr4::ParserRuleContext* parseNode) {
    size_t childAmount = parseNode->children.size();
    if (childAmount == 1) {
        return parseNode->children[0]->accept(this);
    }
...
antlrcpp::Any AstBuilder::binaryExpr(std::function<std::shared_ptr<AstNode>(int)> createNode, antlr4::ParserRuleContext* parseNode) {
    size_t childAmount = parseNode->children.size();
    if (childAmount == 1) {
        return parseNode->children[0]->accept(this);
    }
...
antlr4::Token* AstBuilder::getChildToken(antlr4::tree::ParseTree* parseNode, int childIndex) {
    antlr4::tree::TerminalNode* terminalNode = dynamic_cast<antlr4::tree::TerminalNode*>(parseNode->children[childIndex]);
