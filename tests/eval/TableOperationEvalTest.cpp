...
EVAL_TEST("table_operation.dpl") {
    ...
    expectedOutputLines.push_back("{ 'width': [1, 2, 3, 3, 4, 3], 'height': [4, 5, 6, 7, 8, 6], 'area': [None, 10, None, None, None, None] }");
    expectedOutputLines.push_back("{ 'width': [3], 'height': [6], 'area': [None] }");

    expectedOutputLines.push_back("{ 'width': [2, 3], 'height': [5, 6], 'area': [10, None] }");
    expectedOutputLines.push_back("{ 'width': [1], 'height': [4], 'area': [None] }");
    expectedOutputLines.push_back("{ 'width': [4], 'height': [8], 'area': [None] }");
    
    expectedOutputLines.push_back("{ 'width': [1, 2], 'height': [4, 5], 'area': [None, 10] }");
    expectedOutputLines.push_back("{ 'width': [3, 3], 'height': [7, 6], 'area': [None, None] }");
    ...
    table3->second.insert({"area", columnT3Area});
    ...
    table3->second.insert({"height", columnT3Height});
    ...
    table3->second.insert({"width", columnT3Width});

    //                      
    //               TABLE 4
    //
    dplsrc::Value::TABLE table4 = std::make_shared<std::pair<std::vector<dplsrc::Value::STR>, std::unordered_map<dplsrc::Value::STR, dplsrc::Value::COLUMN>>>();
    ...
    table4->second.insert({"area", columnT4Area});
    ...
    table4->second.insert({"height", columnT4Height});
    ...
    table4->second.insert({"width", columnT4Width});
